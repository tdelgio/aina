  ...
  return (
    <div className="relative bg-black-200 rounded-full p-3 transform scale-125">
      ...
      {cartWidgetItems() === 0 ? null : (
        <div className="flex items-center justify-center font-bold absolute top-0 -right-1 h-4 w-4 lg:h-5 lg:w-5 lg:-right-2 rounded-full bg-red-800 text-red-100 text-xs">
          {cartWidgetItems()}
        </div>
      )}
    </div>
